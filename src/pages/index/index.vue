		...
		<view class="page-content">
			...
			<view class="card-wrapper content-menu">
				...
				<view class="menu-content">
					...
					<view class="margin-bottom">
						<image @click="toMenuItem('新重大危险源监管')" class="margin-right" src="@/static/index/1.png"
							mode="widthFix"></image>
						<image @click="toMenuItem('安全风险分区')" src="@/static/index/2.png" mode="widthFix"></image>
					</view>
					<view>
						<image @click="toMenuItem('隐患排查治理')" class="margin-right" src="@/static/index/3.png"
							mode="widthFix"></image>
						<image @click="toMenuItem('安全培训考核')" src="@/static/index/4.png" mode="widthFix"></image>
					</view>
			...
			<view class="card-wrapper content-menu">
				...
				<view class="menu-content">
					<view>
						<image style="width: 50%;" @click="toMenuItem('封闭园区')" class="margin-right"
							src="@/static/index/7.png" mode="widthFix"></image>
						<image style="width: 50%;" @click="toMenuItem('应急指挥')" src="@/static/index/8.png"
							mode="widthFix"></image>
					</view>
				</view>
			</view>
